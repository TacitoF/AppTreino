...
// NOVO: Importamos a tela de perfil que acabou de criar
...
export default function App() {
  ...
  return (
    <>
      ...
      {/* NOVO: Passamos a propriedade onPerfil para a TelaGrupamentos */}
      ...
      {/* NOVO: Renderizamos a TelaPerfil quando for ativada */}
